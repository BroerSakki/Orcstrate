...
class Stories(Gtk.ApplicationWindow):
    def __init__(self, app):
        super().__init__(application=app, title="Movie")
        ...
        # Header
        # ---
        header = Gtk.Label(label="Jou Movie Opsies")
        ...
        # Output label
        # ---
        self.output = Gtk.Label(label="Moevie>> ")
    ...
    def on_submit(self, widget):
        ...
        self.output.set_text(f"Movie name >>: {text}")
